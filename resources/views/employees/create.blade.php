        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h4 class="mb-0">
                        <i class="fas fa-user-plus"></i> 新規店員登録
                    </h4>
                </div>
                <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('position') is-invalid @enderror"
                                            ...
                                            required>
                                        <option value="">選択してください</option>
                                        <option value="trainee" {{ old('position') == 'trainee' ? 'selected' : '' }}>研修生</option>
                                        <option value="staff" {{ old('position') == 'staff' ? 'selected' : '' }}>スタッフ</option>
                                        <option value="senior_staff" {{ old('position') == 'senior_staff' ? 'selected' : '' }}>主任スタッフ</option>
                                        <option value="supervisor" {{ old('position') == 'supervisor' ? 'selected' : '' }}>主任</option>
                                        <option value="assistant_manager" {{ old('position') == 'assistant_manager' ? 'selected' : '' }}>副店長</option>
                                        <option value="manager" {{ old('position') == 'manager' ? 'selected' : '' }}>店長</option>
                                    </select>
                                    @error('position')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('employment_type') is-invalid @enderror"
                                        ...
                                        <option value="part_time" {{ old('employment_type') == 'part_time' ? 'selected' : '' }}>パートタイム</option>
                                        <option value="contract" {{ old('employment_type') == 'contract' ? 'selected' : '' }}>契約社員</option>
                                        <option value="temporary" {{ old('employment_type') == 'temporary' ? 'selected' : '' }}>臨時雇用</option>
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('status') is-invalid @enderror"
                                            ...
                                            required>
                                        <option value="">選択してください</option>
                                        <option value="active" {{ old('status') == 'active' ? 'selected' : '' }}>在職中</option>
                                        <option value="inactive" {{ old('status') == 'inactive' ? 'selected' : '' }}>休職中</option>
                                        <option value="on_leave" {{ old('status') == 'on_leave' ? 'selected' : '' }}>休暇中</option>
                                        <option value="terminated" {{ old('status') == 'terminated' ? 'selected' : '' }}>退職済み</option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('notes') is-invalid @enderror"
                                          ...
                                          name="notes"
                                          rows="4"
                                          placeholder="特記事項やメモを入力してください">{{ old('notes') }}</textarea>
                                @error('notes')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
